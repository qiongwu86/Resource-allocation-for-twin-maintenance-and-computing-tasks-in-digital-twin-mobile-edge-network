...
class PolicyNetwork(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_size, action_range=0.99, init_w=3e-3, log_std_min=-20,
                 log_std_max=2):
    ...
    def sample_action(self, ):
        a = torch.FloatTensor(self.num_actions).uniform_(0.01, 0.3)
...
class SAC_Trainer():
    ...
    def load_model(self, path):
        ckp1 = torch.load(path + '_q1')
        ckp2 = torch.load(path + '_q2')
